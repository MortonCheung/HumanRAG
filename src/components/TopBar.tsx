...
export function TopBar() {
  ...
  return (
    <WorkspaceHeader title="知识空间" actions={<>
      ...
      <Link className="context-nav__button" to={ROUTES.progress} state={{ returnTo: ROUTES.universe }} aria-label="学习证据" title="学习证据"><Notebook size={18} aria-hidden="true" /><span>学习证据</span></Link>
      <FullscreenButton />
